...
#infn3="prompts3.txt"
hw=1024
infn="prompts_txt/x02" # TODO

#outdir1="outdir1" # ddim_steps=50, seed=42
#outdir2="outdir2" # ddim_steps=200, seed=888
outdir="outdir_x02_$hw" # TODO ddim_steps=200, seed=42, reuse "stable diffusion" paper's prompts and 30 artists
...
python scripts/txt2img_select_gpu.py \
	...
	--seed 42 \
	--device "cuda:3" \
	--config "configs/stable-diffusion/v1-inference-gpu3.yaml" \
	--ckpt "models/ldm/CompVis/stable-diffusion-v-1-4-original/stable-diffusion-v-1-4-original/sd-v1-4.ckpt"
